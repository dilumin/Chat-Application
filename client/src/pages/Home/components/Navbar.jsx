...
function Navbar() {
  ...
  const { profileDropDown, setProfileDropDown, MyInfo, friends } = useContext(HomeContext);
  ...
  return (
    <div>
      ...
      {profileDropDown &&
        ...
        >
          <div className='chec border-black cursor-pointer p-2 text-white'>Profile</div>
          <div className='chec border-black cursor-pointer p-2 text-white'>Sign Out</div>
        </div>
      }
    </div>
  );
